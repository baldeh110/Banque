...
public class Read {
	...
	public String treatement(File file, Map<String, String> mapAttributes) throws Exception {
		return null;
//
...
//		Classifier[] models = { new NaiveBayesUpdateable() };
//
//		// Run for each model
...
//				newInstance.setValue(data.attribute(mapEntry.getKey().toString().trim()), mapEntry.getValue().toString().trim());
//			}
//		}
//
//		double[] results = models[0].distributionForInstance(newInstance);
//		return "GOOD: " + results[0] + "%\n" + "BAD: " + results[0] + "%";
	}
